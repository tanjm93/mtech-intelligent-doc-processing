...
class pdf2content_integrated:
    ...
    def dataprep(self,data_df):
        ...
        df1_columns = ['pg_number', 'Number', 'Type', 'Bbox', 'Text', 'Size', 'Font', 'Color', 'Origin', 'Span_Bbox', 'x0', 'y0', 'x1', 'y1','ocr_det_arr','Header_image','segment_dictionary']
        df2_columns = ['pg_number', 'Number', 'Type', 'Bbox', 'Span_Bbox', 'Width', 'Height', 'Ext', 'Colorspace', 'Xres', 'Yres', 'Bpc', 'Transform', 'Size', 'Image', 'x0', 'y0', 'x1', 'y1','ocr_det_arr','Header_image','segment_dictionary']
